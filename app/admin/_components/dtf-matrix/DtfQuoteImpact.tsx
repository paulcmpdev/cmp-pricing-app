...
function Line({
  ...
  return (
    <div className="flex justify-between items-baseline gap-3">
      <dt className={emphasize ? "text-neutral-300" : "text-neutral-400"}>
        {label}
      </dt>
...
export default function DtfQuoteImpact({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 px-4 sm:px-5 py-3 border-b border-neutral-800 bg-neutral-900/60">
        <h3
      ...
      <div className="p-4 sm:p-5">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5 pb-4 border-b border-neutral-800">
          <div className="flex flex-col gap-1">
            <label
              htmlFor="dtf-quote-product-cost"
              className="text-[11px] uppercase tracking-wider text-neutral-400 font-semibold"
            >
              Product Cost
            </label>
            <input
          ...
          <div className="space-y-4" data-testid="dtf-quote-impact-result">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-md border border-neutral-800 bg-neutral-900/60 p-4">
                <h4 className="text-[11px] uppercase tracking-wider text-neutral-400 font-semibold mb-3">
                  Saved
                </h4>
                {result.current ? (
                  <>
                    <dl className="space-y-1.5 pb-3 mb-3 border-b border-neutral-800">
                      <Line
                        label="Unit Price"
            ...
            {hasOrderDelta && result.delta && (
              <div className="rounded-md border border-neutral-800 bg-neutral-900/60 px-4 py-3 flex items-center justify-between gap-3">
