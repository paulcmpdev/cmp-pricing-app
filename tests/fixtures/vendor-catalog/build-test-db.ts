...
export function buildVendorCatalogTestDb(dbPath: string) {
  ...
  db.exec(`
    ...
    INSERT INTO catalog_variants VALUES
      ('ss:3001-BLK-M', 'ss:3001', 'ss', '3001-BLK-M', '3001', 'Black', 'M', 30, 42, 'https://example.test/3001-black.jpg', 0, 5.00, 4.80, 4.50, 4.75, 4.25, 5.00, 'piecePrice', '2025-09-09T00:00:00.000Z'),
